...
def test_roaudter_provider_hint_local_only(monkeypatch) -> None:
    # на всякий случай убираем все ключи, чтобы не было соблазна уйти в облако
    ...
    comm.send_data(
        "roaudter",
        {"msg": "Say only: pong", "intent": "chat", "provider_hint": "local_only"},
    )
