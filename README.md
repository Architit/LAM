...
В репозитории пока размещены только текстовые материалы. Структура каталогов будет введена по мере развития проекта.

- src/ — основной код LAM
- docs/ — документация и философские тексты
- memory/ — ядро памяти LAM
- experiments/ — результаты исследований и развития
