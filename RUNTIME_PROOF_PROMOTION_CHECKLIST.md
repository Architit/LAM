...
- [ ] `pytest` available after bootstrap (`.venv/bin/python -m pytest --version`)
- [ ] Required CI submodules initialized:
...
- required CI submodule commit unreachable on remote (`not our ref`)
